...
int main()
{
	...
	Texture texture3("white_chessman_texture.jpg");
	...
	Shader myShader("vertex_shader.txt", "fragment_shader.txt");
	Shader objectShader("objects_vertex_shader.txt", "objects_fragment_shader.txt");
	Shader cubeMapShader("cube_map_vertex_shader.txt", "cube_map_fragment_shader.txt");
